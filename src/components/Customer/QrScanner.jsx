...
//         {/* Close */}
//         <button className="absolute top-3 right-4 text-2xl text-gray-500 hover:text-red-500" onClick={onClose}>
//           <FontAwesomeIcon icon={faTimes} />
//          </button>

//          <h2 className="text-xl font-bold text-center text-blue-700 mb-4">Scan QR Code</h2>

//             {!scannedData ? (
//               <div className="relative w-[380px] h-[400px] border-4 border-blue-500 rounded overflow-hidden mb-2">
//                 <video ref={videoRef} className="w-full h-full object-cover" />
//                 <div className="absolute border-2 border-blue-500 rounded w-60 h-56 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
//               </div>
//             ) : (

//               <div className="space-y-3 mb-4 text-sm bg-blue-50 p-4 rounded-xl">
//                <p><FontAwesomeIcon icon={faIdCard} className="text-blue-600 mr-2" /> <strong>Customer ID:</strong> CUST-{scannedData.customerId}</p>
//                <p><FontAwesomeIcon icon={faUser} className="text-blue-600 mr-2" /> <strong>Name:</strong> {scannedData.userName}</p>
//                <p><FontAwesomeIcon icon={faPhone} className="text-blue-600 mr-2" /> <strong>Phone:</strong> {scannedData.phone}</p>
//                <p><FontAwesomeIcon icon={faWallet} className="text-blue-600 mr-2" /> <strong>Available Points:</strong> {scannedData.verifiedBalance ?? scannedData.availableBalance ?? 0}</p>
//              </div>
//               {associated && (
//               <form onSubmit={handleSubmitBoth} className="space-y-3">
//                 <input name="amount" type="number" min="1" placeholder="Enter Points" required className="w-full px-4 py-2 border rounded" />
//                 <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-black-500 font-bold">$</span>
//                 <input name="dollar" type="number" min="1" placeholder="Enter $ Amount" required className="w-full px-4 py-2 border rounded" />
//                 {error && <p className="text-red-500 text-sm">{error}</p>}
...
//         {!scannedData ? (
//           <>
//             <div className="relative w-full h-[300px] rounded-xl border-4 border-blue-500 overflow-hidden">
//               <video ref={videoRef} className="w-full h-full object-cover" />
//               <div className="absolute inset-0 m-12 border-2 border-blue-700 rounded-xl pointer-events-none" />
//             </div>
//             <p className="text-center text-sm text-gray-600 mt-3">
//               <span className="font-semibold">Guidance:</span> Allow camera access. Prefer rear camera on mobile.
//             </p>
//           </>
//         ) : (
//           <>
...
//           {scannedData && (
//             <button onClick={handleScanAgain} className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded">
//               <FontAwesomeIcon icon={faRedo} className="mr-2" />
//               Scan Again
//             </button>
//           )}
//           <button onClick={onClose} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">Close</button>
//         </div>
