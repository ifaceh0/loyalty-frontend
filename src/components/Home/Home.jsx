    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="relative h-[600px] overflow-hidden">
        <div className="relative w-full h-full">
          ...
          <button onClick={prevSlide} className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-sm text-white p-3 rounded-full hover:bg-white/40 transition">
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button onClick={nextSlide} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-sm text-white p-3 rounded-full hover:bg-white/40 transition">
            <ChevronRight className="w-6 h-6" />
          </button>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: <CheckCircle className="w-12 h-12 text-emerald-600" />, title: t('home.howItWorks.step1'), desc: t('home.howItWorks.step1Desc') },
              { icon: <Store className="w-12 h-12 text-teal-600" />, title: t('home.howItWorks.step2'), desc: t('home.howItWorks.step2Desc') },
              { icon: <Gift className="w-12 h-12 text-indigo-600" />, title: t('home.howItWorks.step3'), desc: t('home.howItWorks.step3Desc') },
            ].map((step, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-50 to-teal-50">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { Icon: Users, label: t('home.stats.members'), value: stats.totalUsers },
              { Icon: Store, label: t('home.stats.stores'), value: stats.totalShops },
              { Icon: DollarSign, label: t('home.stats.rewards'), value: stats.totalTransactionAmount, prefix: '$' },
            ].map((stat, i) => (
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[t('home.benefits.noFees'), t('home.benefits.nationwide'), t('home.benefits.instant'), t('home.benefits.referral')].map((benefit, i) => (
