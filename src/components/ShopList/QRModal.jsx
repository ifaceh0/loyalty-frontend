    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 overflow-y-auto">
        <motion.div 
          ...
          className="bg-white w-full max-w-sm sm:max-w-md rounded-[0.5rem] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] overflow-hidden relative border border-slate-100"
        >
            ...
            <div className="flex flex-col items-center">
              <div className="relative group p-2 bg-slate-50 rounded-[0.5rem] border-2 border-dashed border-slate-200">
                <img
                  src={qrData.qrCode}
                  alt="QR Code"
                  className="w-48 h-48 sm:w-56 sm:h-56 rounded-lg shadow-sm bg-white p-2"
                />
              </div>
